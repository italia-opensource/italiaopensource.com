      ...
      <Grid container padding={1} marginTop={2}>
        ...
        <Grid xs={12} sm={6} smOffset={3} padding={2} textAlign={'left'}>
          <Typography variant="h5" component="h2" >
            <ArrowCircleRightIcon className='primary'/>  What is an open-source project?
          </Typography>
        ...
        <Grid xs={12} sm={6} smOffset={3} padding={2} textAlign={'left'}>
          <Typography variant="h5" component="h2" >
            <ArrowCircleRightIcon className='primary'/> How do you collaborate on an open-source project?
          </Typography>
          <Typography marginBottom={1}>
        ...
        <Grid xs={12} sm={6} smOffset={3} padding={2} textAlign={'left'}>
          <Typography variant="h5" component="h2" >
            <ArrowCircleRightIcon className='primary'/> How do I add an open-source project to the list?
          </Typography>
          <Typography marginBottom={1}>
